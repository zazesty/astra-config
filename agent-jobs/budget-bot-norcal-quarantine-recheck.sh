...
REPORT="$(cd "$BUDGET_BOT_ROOT" && python3 - <<'PY'
import json
from datetime import datetime, timezone
from pathlib import Path
from budget_bot.plaid_client import item_get
from budget_bot.plaid_sync import list_items, load_access_token, preview_item, set_item_flags
